...
class AppLocalizations {
  ...
  _fallbackLocalizedValues = <String, Map<String, String>>{
    'en': <String, String>{
      ...
      'account.changeEmailAddress': 'Update Email Address',
      'account.changePhoneNumber': 'Update Phone Number',
      'account.updateEmailSubHeader': 'Please enter your new email address',
      'account.updatePhoneSubHeader': 'Please enter your new phone number',
      'account.newEmailAddress': 'New Email Address',
      'account.enterNewEmailAddress': 'Enter New Email Address',
      'account.emailRequired': 'Please enter email address',
      'account.emailInvalid': 'Invalid email address',
      'account.emailUnchanged': 'Email is unchanged',
      'account.phoneInvalid': 'Please enter a valid mobile number',
      'account.phoneUnchanged': 'Phone number is unchanged',
      ...
      'account.emailUpdatedLogout':
          'Email updated successfully. You will be logged out now.',
      'account.updatePhoneTitle': 'Update Phone Number',
      'account.mobileNumber': 'Mobile Number',
      'account.phoneUpdatedSuccess': 'Successfully Changed Phone Number',
      'account.verificationCodePhonePrefix':
          'Please enter the 4 digit security code sent to your mobile no.',
      'account.verificationCodeEmailPrefix':
          'Please enter the 4 digit security code sent to your email address',
      'account.resendNow': 'RESEND NOW',
      'account.passwordUpdateSuccess': 'Password updated successfully. You will be logged out now.',
      ...
      'account.repeatNewPasswordHint': 'Repeat New Password',
      'account.currentPasswordRequired': 'Current password is required',
      'account.newPasswordRequired': 'New password is required',
      'account.repeatPasswordRequired': 'Repeat new password is required',
      'account.passwordStrengthError':
      ...
      'account.passwordNoMatch': 'Passwords do not match',
      'account.oldPasswordNotMatched': 'Current password is not correct',
      'account.previousPasswordError': 'New password cannot be one of your previous passwords',
      'account.passwordUpdateFailed': 'Password update failed. Please try again.',
      ...
      'survey.title': 'Survey',
      'survey.overviewTitle': 'Overview of all your personal and financial surveys.',
      'survey.takeServiceCheck': 'Take Service Check',
      'survey.viewPreviousAnswer': 'View Previous Answers',
      'survey.infoUpdateMessage':
          'If the information you provide is not up-to-date,It can be updated',
      'survey.updatePersonalDetails': 'Update My Personal Details',
      'survey.serviceCheckTitle': 'Service Check',
      'survey.previousAnswerTitle': 'Previous Answer',
      'survey.submittedOn': 'Submitted on 25.04.2026',
      'survey.questionOneSerial': 'Question One',
      'survey.questionTwoSerial': 'Question Two',
      'survey.questionThreeSerial': 'Question Three',
      'survey.questionFourSerial': 'Question Four',
      'survey.questionFiveSerial': 'Question Five',
      'survey.questionSixSerial': 'Question Six',
      'survey.questionOneTitle': 'Verification of contact details',
      'survey.questionTwoTitle':
          'Has there been any change in your personal situation (marriage, children, career etc.)?',
      'survey.questionThreeTitle':
          'Has your living situation changed in the last 12 months or are you planning to move soon?',
      'survey.questionFourTitle':
          'Are you planning to make larger investments in the future (photovoltaic, outbuilding, bicycle, new hobby, drone, car purchase, musical instrument, apartment renovation, etc.)?',
      'survey.questionFiveTitle':
          'I would like advice regarding the following topics (multiple choices possible):',
      'survey.questionSixTitle':
          'Would you like to schedule an in-person or virtual consultation appointment? If yes, your Financial Planner will contact you.',
      'survey.disclaimer':
          'Disclamer: This service check is for informational purposes only and serves as a superficial assesment of your situation. Swiss Life Select or your financial Planner will not make any changes to your insurance provisions or investments solely based on the information provided.Please discuss all changes with your Financial Planner.If you have urgent modification needs.Please contact your Financial Planner immediately.',
      'survey.submit': 'Submit',
      'survey.yes': 'Yes',
      'survey.no': 'No',
      'survey.q1yes': 'All data is up to date',
      'survey.q1no': 'This information is unfortunately outdated (Please update)',
      'survey.q1footer':
          'For any further changes (bank details, new ID, etc.) please contract your Financial Planner directly.',
      'survey.q6yes': 'Yes, I would like to schedule an appoinment.',
      'survey.q6noShort': 'No, I don\'t want to schedule an appointment...',
      'survey.retirement': 'Retirement',
      'survey.coverage': 'Coverage',
      'survey.financing': 'Financing',
      'survey.investment': 'Investment',
      'survey.realEstate': 'Real estate',
      'survey.q5retirement1': 'Review of existing provisions.',
      'survey.q5retirement2': 'I would like to set up a provision/saving plan.',
      'survey.q5retirement3': 'I would like to plan for my children\'s future.',
      'survey.q5coverage1': 'Review of existing coverage.',
      'survey.q5coverage2': 'I would like to secure my income.',
      'survey.q5coverage3': 'I would like to secure the future of my dependents.',
      'survey.q5financing1': 'New lease/financing',
      'survey.q5financing2': 'Review of existing financing',
      'survey.q5investment1': 'Monthly saving',
      'survey.q5investment2': 'Investing a lump sum amount',
      'survey.q5realestate1': 'Real estate purchase',
      'survey.q5realestate2': 'Real estate sale',
      'survey.q5realestate3': 'Investment property/developer model',
      'survey.nameLabel': 'Name',
      'survey.emailLabel': 'Email',
      'survey.phoneLabel': 'Phone Number',
      'survey.addressLabel': 'Address',
      'survey.sampleNameValue': 'Asaduzzaman Shuvo',
      'survey.sampleEmailValue': 'asaduzzaman.shuvo@selise.ch',
      'survey.samplePhoneValue': '+8801867512994',
      'survey.sampleAddressValue': 'Bakultala, 3622, Fohra, Bangladesh',
      'about.title': 'About',
    ...
    'de': <String, String>{
      ...
      'account.changeEmailAddress': 'E-Mail-Adresse aktualisieren',
      'account.changePhoneNumber': 'Telefonnummer aktualisieren',
      'account.updateEmailSubHeader':
          'Bitte geben Sie Ihre neue E-Mail-Adresse ein',
      'account.updatePhoneSubHeader':
          'Bitte geben Sie Ihre neue Telefonnummer ein',
      'account.newEmailAddress': 'Neue E-Mail-Adresse',
      'account.enterNewEmailAddress': 'Neue E-Mail-Adresse eingeben',
      'account.emailRequired': 'Bitte E-Mail-Adresse eingeben',
      'account.emailInvalid': 'Ungültige E-Mail-Adresse',
      'account.emailUnchanged': 'E-Mail ist unverändert',
      'account.phoneInvalid': 'Bitte eine gültige Mobilnummer eingeben',
      'account.phoneUnchanged': 'Telefonnummer ist unverändert',
      ...
      'account.emailUpdatedLogout':
          'E-Mail erfolgreich aktualisiert. Sie werden jetzt abgemeldet.',
      'account.updatePhoneTitle': 'Mobilnummer aktualisieren',
      'account.mobileNumber': 'Mobilnummer',
      'account.phoneUpdatedSuccess': 'Mobilnummer erfolgreich geändert',
      'account.verificationCodePhonePrefix':
          'Bitte geben Sie den 4-stelligen Sicherheitscode ein, der an Ihre Mobilnummer gesendet wurde',
      'account.verificationCodeEmailPrefix':
          'Bitte geben Sie den 4-stelligen Sicherheitscode ein, der an Ihre E-Mail-Adresse gesendet wurde',
      'account.resendNow': 'NEU SENDEN',
      'account.passwordUpdateSuccess': 'Passwort erfolgreich aktualisiert. Sie werden jetzt abgemeldet.',
      ...
      'account.changePasswordTitle': 'Passwort ändern',
      'account.enterCurrentPassword': 'Aktuelles Passwort eingeben',
      'account.enterNewPassword': 'Neues Passwort eingeben',
      'account.repeatNewPasswordHint': 'Neues Passwort wiederholen',
      'account.currentPasswordRequired':
          'Aktuelles Passwort ist erforderlich',
      'account.newPasswordRequired': 'Neues Passwort ist erforderlich',
      'account.repeatPasswordRequired':
          'Wiederholung des neuen Passworts ist erforderlich',
      'account.passwordStrengthError':
          'Das Passwort muss mindestens 6 Zeichen enthalten und mindestens einen Großbuchstaben, einen Kleinbuchstaben, ein Sonderzeichen und eine Ziffer beinhalten.',
      'account.passwordMinLength': 'Passwort muss mindestens 8 Zeichen lang sein',
      'account.passwordNoMatch': 'Passwörter stimmen nicht überein',
      'account.oldPasswordNotMatched': 'Das aktuelle Passwort ist nicht korrekt',
      'account.previousPasswordError': 'Das neue Passwort darf keines Ihrer früheren Passwörter sein',
      'account.passwordUpdateFailed': 'Passwortaktualisierung fehlgeschlagen. Bitte versuchen Sie es erneut.',
      ...
      'survey.overviewTitle': 'Ubersicht uber Ihre Service-Checks',
      'survey.takeServiceCheck': 'Service Check ausfullen',
      'survey.viewPreviousAnswer': 'Vorherige Antworten ansehen',
      'survey.infoUpdateMessage':
          'Wenn die von Ihnen bereitgestellten Informationen nicht auf dem neuesten Stand sind, konnen sie aktualisiert werden',
      'survey.updatePersonalDetails': 'Meine personlichen Daten aktualisieren',
      'survey.serviceCheckTitle': 'Service Check',
      'survey.previousAnswerTitle': 'Vorherige Antworten',
      'survey.submittedOn': 'Abgeschickt am 25.04.2026',
      'survey.questionOneSerial': 'Frage Eins',
      'survey.questionTwoSerial': 'Frage Zwei',
      'survey.questionThreeSerial': 'Frage Drei',
      'survey.questionFourSerial': 'Frage Vier',
      'survey.questionFiveSerial': 'Frage Funf',
      'survey.questionSixSerial': 'Frage Sechs',
      'survey.questionOneTitle': 'Uberprufung der Kontaktdaten',
      'survey.questionTwoTitle':
          'Gab es Veranderungen in Ihrer personlichen Situation (Heirat, Kinder, Karriere usw.)?',
      'survey.questionThreeTitle':
          'Hat sich Ihre Wohnsituation in den letzten 12 Monaten verandert oder planen Sie bald umzuziehen?',
      'survey.questionFourTitle':
          'Planen Sie in Zukunft grossere Investitionen (Photovoltaik, Anbau, Fahrrad, neues Hobby, Drohne, Autokauf, Musikinstrument, Wohnungsrenovierung usw.)?',
      'survey.questionFiveTitle':
          'Ich mochte Beratung zu den folgenden Themen (Mehrfachauswahl moglich):',
      'survey.questionSixTitle':
          'Mochten Sie einen personlichen oder virtuellen Beratungstermin vereinbaren? Wenn ja, kontaktiert Sie Ihr Financial Planner.',
      'survey.disclaimer':
          'Disclaimer: Dieser Service Check dient nur der oberflachlichen Abfrage Ihrer Situation. Swiss Life Select bzw. Ihr Financial Planner werden auf Basis Ihrer Angaben selbststandig keine Anderungen hinsichtlich Ihrer Absicherungen, Vorsorgen oder Investments durchfuhren. Bitte besprechen Sie alle Anderungen mit Ihrem Financial Planner. Sollten Sie dringenden Anderungsbedarf haben, nehmen Sie bitte umgehend Kontakt mit Ihrem Financial Planner auf.',
      'survey.submit': 'Submit',
      'survey.yes': 'Ja',
      'survey.no': 'Nein',
      'survey.q1yes': 'Alle Daten sind aktuell',
      'survey.q1no':
          'Diese Informationen sind leider veraltet (Informationen wurden in der KVV geandert)',
      'survey.q1footer':
          'Fur weitere Anderungen (Bankdaten, neue ID usw.) kontaktieren Sie bitte direkt Ihren Financial Planner.',
      'survey.q6yes': 'Ja, ich mochte einen Termin vereinbaren.',
      'survey.q6noShort': 'Nein, ich mochte aktuell keinen Termin vereinbaren...',
      'survey.retirement': 'Vorsorge',
      'survey.coverage': 'Absicherung',
      'survey.financing': 'Finanzierung',
      'survey.investment': 'Investment',
      'survey.realEstate': 'Immobilie',
      'survey.q5retirement1': 'Uberprufung bestehender Vorsorgen.',
      'survey.q5retirement2':
          'Ich mochte eine Vorsorge-/Sparlosung einrichten.',
      'survey.q5retirement3':
          'Ich mochte fur die Zukunft meiner Kinder planen.',
      'survey.q5coverage1': 'Uberprufung bestehender Absicherungen.',
      'survey.q5coverage2': 'Ich mochte mein Einkommen absichern.',
      'survey.q5coverage3':
          'Ich mochte die Zukunft meiner Angehorigen absichern.',
      'survey.q5financing1': 'Neue Finanzierung/Leasing',
      'survey.q5financing2': 'Uberprufung bestehender Finanzierungen',
      'survey.q5investment1': 'Monatlich sparen',
      'survey.q5investment2': 'Einmalbetrag investieren',
      'survey.q5realestate1': 'Immobilienkauf',
      'survey.q5realestate2': 'Immobilienverkauf',
      'survey.q5realestate3': 'Anlageimmobilie/Entwicklermodell',
      'survey.nameLabel': 'Name',
      'survey.emailLabel': 'Email',
      'survey.phoneLabel': 'Phone Number',
      'survey.addressLabel': 'Address',
